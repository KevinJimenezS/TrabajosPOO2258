...
public class VentanaV extends JFrame {
    ...
    public VentanaV(String title) throws HeadlessException {
        super(title);
        ...
        panel1.setBackground(new Color(95, 211, 215));
        lblId = new JLabel("ID: ");
        ...
        panel2.setBackground(new Color(132, 54, 204));
        info = new ArrayList<>();
        info.add(new VideoJuego(1, "League Of Legends", "MOBA", 4.5, "PC", "RIOT"));
